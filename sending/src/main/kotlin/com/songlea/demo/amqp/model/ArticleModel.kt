 ...
 * @author Song Lea
 */
data class ArticleModel(var id: Int, var title: String, var content: String, var userId: Int,
                        var createTime: String, var userName: String) {

    // 默认的无参数构造器
    constructor() : this(-1, ProjectCommonUtil.DEFAULT_EMPTY, ProjectCommonUtil.DEFAULT_EMPTY,
            -1, ProjectCommonUtil.DEFAULT_EMPTY, ProjectCommonUtil.DEFAULT_EMPTY)
